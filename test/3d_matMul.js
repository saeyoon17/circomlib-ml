...
describe("3d_matMul layer test", function () {
    this.timeout(100000000);

    it("3d_matMul", async () => {
        let json = require("../models/3d_matMul_input.json");
        let OUTPUT = require("../models/3d_matMul_output.json");

        const circuit = await wasm_tester(path.join(__dirname, "circuits", "3d_matMul_test.circom"));
